...
Patch181:bind98-rh1306504.patch
Patch182:bind98-CVE-2016-2848.patch
Patch183:bind98-rh1325081.patch
Patch184:bind98-rh1313286.patch
Patch185:bind-99-socket-maxevents.patch
Patch186:bind-9.10-rh1259923.patch
Patch187:bind98-CVE-2016-8864.patch
Patch188:bind99-CVE-2016-9147.patch
Patch189:bind99-rt43779.patch
# ISC 4558
Patch190:bind99-rt44318.patch
# ISC 4575
...
%patch181 -p1 -b .rh1306504
%patch182 -p1 -b .CVE-2016-2848
%patch183 -p1 -b .rh1325081
%patch184 -p1 -b .rh1313286
%patch185 -p1 -b .sock-maxevents
%patch186 -p1 -b .rh1259923
...
%patch187 -p1 -b .CVE-2016-8864
%patch188 -p1 -b .CVE-2016-9147
%patch189 -p1 -b .rt43779
%patch190 -p1 -b .rt44318
%patch191 -p1 -b .CVE-2017-3136
...
mkdir -p ${RPM_BUILD_ROOT}/%{chroot_prefix}/%{_lib}
...
* Wed Feb 08 2017 Petr Menšík <pemensik@redhat.com> - 32:9.8.2-0.62.rc1
- Fix and test caching CNAME before DNAME (ISC change 4558)

* Tue Jan 10 2017 Petr Menšík <pemensik@redhat.com> - 32:9.8.2-0.61.rc1
- Fix CVE-2016-9147 (ISC change 4510)
- Fix regression introduced by CVE-2016-8864 (ISC change 4530)

* Tue Nov 22 2016 Petr Menšík <pemensik@redhat.com> - 32:9.8.2-0.60.rc1
- Restore SELinux contexts before named restart

* Mon Oct 31 2016 Petr Menšík <pemensik@redhat.com> - 32:9.8.2-0.59.rc1
- Use /lib or /lib64 only if directory in chroot already exists
- Tighten NSS library pattern, escape chroot mount path

* Mon Oct 31 2016 Tomas Hozza <thozza@redhat.com> - 32:9.8.2-0.58.rc1
- Fix CVE-2016-8864

* Thu Oct 20 2016 Petr Menšík <pemensik@redhat.com> - 32:9.8.2-0.57.rc1
- Do not change lib permissions in chroot (#1321239)
- Support WKS records in chroot (#1297562)

* Thu Oct 20 2016 Petr Menšík <pemensik@redhat.com> - 32:9.8.2-0.56.rc1
- Do not include patch backup in docs (fixes #1325081 patch)

* Wed Oct 19 2016 Petr Menšík <pemensik@redhat.com> - 32:9.8.2-0.55.rc1
- Backported relevant parts of [RT #39567] (#1259923)

* Wed Oct 19 2016 Petr Menšík <pemensik@redhat.com> - 32:9.8.2-0.54.rc1
- Increase ISC_SOCKET_MAXEVENTS to 2048 (#1326283)

* Tue Oct 18 2016 Petr Menšík <pemensik@redhat.com> - 32:9.8.2-0.53.rc1
- Fix multiple realms in nsupdate script like upstream (#1313286)

* Mon Oct 17 2016 Petr Menšík <pemensik@redhat.com> - 32:9.8.2-0.52.rc1
- Fix multiple realm in nsupdate script (#1313286)

* Mon Oct 17 2016 Petr Menšík <pemensik@redhat.com> - 32:9.8.2-0.51.rc1
- Use resolver-query-timeout high enough to recover all forwarders (#1325081)

* Mon Oct 17 2016 Tomas Hozza <thozza@redhat.com> - 32:9.8.2-0.50.rc1
- Fix CVE-2016-2848


* Fri Oct 14 2016 Petr Menšík <pemensik@redhat.com> - 32:9.8.2-0.49.rc1
- Fix infinite loop in start_lookup (#1306504)

* Fri Sep 23 2016 Tomas Hozza <thozza@redhat.com> - 32:9.8.2-0.48.rc1
- Fix CVE-2016-2776
